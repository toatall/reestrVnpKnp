...
<div class="well">    
    <?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
        ...
        <table>            
            ...
            setTableRow($form, $model, 'query_in_otdel_UZ_conclusion', false,
            		$form->dropDownList($model, 'query_in_otdel_UZ_conclusion', array(''=>'',0=>'нет',1=>'да')), 'равно');
            setTableRow($form, $model, 'query_in_otdel_UZ_date', true);
            setTableRow($form, $model, 'query_in_otdel_UZ_from_IFNS_date', true);
            ...
            setTableRow($form, $model, 'date_create', true);
